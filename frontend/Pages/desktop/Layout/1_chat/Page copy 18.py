...
class Page(QWidget):
    ...
    def init_right_sidebar(self):
        ...
        self.developer_workflow_combobox.addItems(["Standard Workflow - developer", "Advanced Workflow - developer"])
        ...
        self.crew_workflow_combobox.addItems(["Standard Workflow - crew", "Advanced Workflow - crew"])
        ...
        self.temperature_slider.setRange(0, 100)  # Representing 0.0 to 1.0
        ...
        # Spacer
        layout.addStretch()
        logger.debug("Right sidebar initialized with agent selection and LLM settings.")
...
"""
            self.append_markdown(formatted_message)
            # Store all code blocks in Code Blocks tab
            for match in matches:
                language = match[0] if match[0] else 'text'
                code = match[1]
                self.add_code_block(code, language)
