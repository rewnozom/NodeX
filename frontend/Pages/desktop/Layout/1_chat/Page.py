...
class Page(QWidget):
    ...
    def init_ui(self):
        """
        Set up the user interface with all main components.
        """
        ...
        # Main vertical layout to hold all content
        main_layout = QVBoxLayout(self)
        main_layout.setContentsMargins(5, 5, 5, 5)
        main_layout.setSpacing(5)

        # Initialize the controls widget and add to main layout
        self.init_controls()
        ...
        logger.debug("Components added to main splitter.")

        # Set sizes and constraints for sidebars
        self.left_sidebar.setMaximumWidth(300)
        self.left_sidebar.setMinimumWidth(150)
        ...
        logger.debug("Splitter sizes and constraints set.")
    ...
    def init_controls(self):
        ...
        self.max_tokens_slider.setRange(100, 4000)
        ...
        self.max_tokens_spinbox.setToolTip("Max tokens (100 - 4000)")
    ...
    def init_status_bar(self):
        ...
        # Add stretch to separate status and agent labels
        ...
        logger.debug("Status bar initialization complete.")
    ...
    def init_chat_history_tab(self):
        ...
        for button in [self.new_chat_button, self.load_chat_button, self.rename_chat_button, self.delete_chat_button, self.clear_chat_button]:
    ...
    def init_file_management_tab(self):
        ...
        self.upload_file_button.setIcon(QIcon(ICONS.get('upload', '')))  # Ensure 'upload' icon exists in ICONS
        self.view_files_button = QPushButton("View")
        self.view_files_button.setIcon(QIcon(ICONS.get('view', '')))  # Ensure 'view' icon exists in ICONS
    ...
    def init_processing_tab(self):
        ...
        self.start_processing_button.setIcon(QIcon(ICONS.get('process', '')))  # Ensure 'process' icon exists
        ...
        self.stop_processing_button.setIcon(QIcon(ICONS.get('stop', '')))  # Ensure 'stop' icon exists
    ...
    def init_main_content(self):
        ...
        main_layout.setContentsMargins(5, 5, 5, 5)
        main_layout.setSpacing(2)  # Reduce spacing between components
        ...
        main_layout.addWidget(self.user_input_widget, 0)  # Use `0` for fixed height of user input
        main_layout.setStretch(0, 9)  # Set stretch factor for chat display (expand more)
        main_layout.setStretch(1, 1)  # Minimize space used by user input area
        logger.debug("User input area added with adjusted spacing.")
    ...
    def init_user_input(self):
        ...
        layout.setSpacing(5)  # Ensure a small but consistent space between widgets
        ...
        self.user_message_textedit.setFixedHeight(50)  # Compact height for input area
        ...
        self.send_button.setFixedHeight(50)  # Match height of text edit
    ...
    def display_user_message(self, message):
        ...
        # Updated regex to make trailing newline optional
        ...
        if matches:
            ...
            for i in range(len(parts)):
                if i % 3 == 0:
                    # Regular text
                    formatted_message += parts[i].strip() + "\n\n"
                elif i % 3 == 1:
                    # Language specifier
