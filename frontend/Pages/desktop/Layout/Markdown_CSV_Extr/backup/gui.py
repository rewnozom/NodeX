# -*- coding: utf-8 -*-
# ./frontend/Pages/desktop/Layout/Markdown_CSV_Extr/gui.py

from frontend.Pages.desktop.Layout.Markdown_CSV_Extr.extractorz import ExtractorWorker, ReverseCSVEx, ReverseMarkdownEx, MarkdownEx, CSVEx
...
class EntryRunFrame(QFrame):
    ...
    def run_command(self):
        ...
        from frontend.Pages.desktop.Layout.Markdown_CSV_Extr.extractorz import CSVEx, MarkdownEx
...
class App(QMainWindow):
    def __init__(self):
        super().__init__()
        self.settings_path = "./frontend/pages/desktop/Layout/Markdown_CSV_Extr/settings.toml"
