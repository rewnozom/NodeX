...
class Page(QWidget):
    ...
    def init_main_content(self):
        ...
        main_layout.addWidget(self.user_input_widget, 0)  # Fixed size
    ...
    def init_user_input(self):
        ...
        layout = QHBoxLayout(self.user_input_widget)
        ...
        logger.debug("Token count label added.")
    ...
    def init_right_sidebar(self):
        """
        Initialize the right sidebar with agent selection, presets, and LLM settings.
        """
        ...
        agent_group_label = QLabel("Agent Selection")
        agent_group_label.setAlignment(Qt.AlignCenter)
        agent_group_label.setObjectName("agentGroupLabel")  # For theming
        layout.addWidget(agent_group_label)

        # Developer Agent Checkbox
        self.developer_toggle = QCheckBox("Enable Developer Agent")
        self.developer_toggle.setObjectName("developerToggle")  # For theming
        self.developer_toggle.stateChanged.connect(lambda state: self.toggle_agent_mode('developer', state == Qt.Checked))
        layout.addWidget(self.developer_toggle)

        # Developer Workflow Preset ComboBox
        ...
        self.developer_workflow_combobox.setEnabled(False)
        ...
        layout.addWidget(self.developer_workflow_combobox)
        logger.debug("Developer Workflow ComboBox added.")

        # Crew Agent Checkbox
        self.crew_toggle = QCheckBox("Enable Crew Agent")
        self.crew_toggle.setObjectName("crewToggle")  # For theming
        self.crew_toggle.stateChanged.connect(lambda state: self.toggle_agent_mode('crew', state == Qt.Checked))
        layout.addWidget(self.crew_toggle)

        # Crew Workflow Preset ComboBox
        ...
        self.crew_workflow_combobox.setEnabled(False)
        ...
        layout.addWidget(self.crew_workflow_combobox)
        logger.debug("Crew Workflow ComboBox added.")

        # Workflow Status Label
        self.workflow_status = QLabel("Developer Workflow: None | Crew Workflow: None")
        self.workflow_status.setObjectName("workflowStatus")  # For theming
        self.workflow_status.setStyleSheet("color: gray;")
        layout.addWidget(self.workflow_status)
        logger.debug("Workflow status label added.")

        # Spacer
        layout.addSpacing(20)

        # LLM Settings Group
        llm_settings_label = QLabel("LLM Settings")
        llm_settings_label.setAlignment(Qt.AlignCenter)
        llm_settings_label.setObjectName("llmSettingsLabel")  # For theming
        layout.addWidget(llm_settings_label)

        # Temperature Slider and SpinBox
        temp_layout = QHBoxLayout()
        temp_label = QLabel("Temperature:")
        temp_layout.addWidget(temp_label)

        self.temperature_slider = QSlider(Qt.Horizontal)
        self.temperature_slider.setRange(0, 200)  # Representing 0.0 to 2.0
        ...
        logger.debug("Temperature controls added.")

        # Max Tokens Slider and SpinBox
        tokens_layout = QHBoxLayout()
        tokens_label = QLabel("Max Tokens:")
        tokens_layout.addWidget(tokens_label)

        self.max_tokens_slider = QSlider(Qt.Horizontal)
        self.max_tokens_slider.setRange(100, 4000)  # Example range
        self.max_tokens_slider.setValue(self.max_tokens)
        ...
        logger.debug("Max Tokens controls added.")

        # Spacer
        layout.addStretch()
        logger.debug("LLM Settings group initialized.")
    ...
    def init_main_content(self):
        """
        Initialize the main content area with chat display and user input.
        """
        logger.debug("Initializing main content area.")
        self.main_content = QWidget()
        main_layout = QVBoxLayout(self.main_content)
    ...
    def display_user_message(self, message):
        ...
        Handles code blocks by adding them to the Code Blocks tab.
