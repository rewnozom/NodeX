...
class AIOutputUserInput(QFrame):
    ...
    def _init_phone_ui(self):
        ...
        #(Valfritt) Lägg till VoiceInputButton om röstinmatning ska inkluderas
        self.voice_input_button = VoiceInputButton(self.input_container)
        self.voice_input_button.voiceInput.connect(self._handle_voice_input)
        input_row_layout.addWidget(self.voice_input_button)
