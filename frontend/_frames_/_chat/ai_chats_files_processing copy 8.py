...
class AIChatFilesProcessing(QFrame):
    ...
    def _init_desktop_ui(self):
        ...
        self.new_chat_button.setMinimumSize(100, 40)
        self.new_chat_button.setObjectName("desktopNewChatButton")
        layout.addWidget(self.new_chat_button)

        # Upload Button
        self.upload_button = QPushButton("Upload File")
        self.upload_button.setIcon(QIcon(ICONS.get('upload', '')))
        self.upload_button.setToolTip("Upload a file for processing")
        self.upload_button.setMinimumSize(100, 40)
        self.upload_button.setObjectName("desktopUploadButton")
        ...
        layout.addWidget(self.extensions_lineedit)
