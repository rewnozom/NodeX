# pages/qframes/helper/CodeBlockExtractor.py
...
from .CodeAnalysis import CodeAnalysisResult
import zipfile
...
class CodeBlockExtractor:
    ...
    def save_analysis_results(self, analysis_results: List[CodeAnalysisResult]):
        ...
        with open(summary_path, 'w', encoding='utf-8') as summary_file:
            ...
            for idx, result in enumerate(analysis_results, 1):
                ...
                file_extension = self.get_file_extension(result.language)
                file_name = f"code_block_{idx}.{file_extension}"
    ...
    def get_file_extension(self, language: str) -> str:
        """
        Maps programming languages to common file extensions.
        """
        extension_map = {
            'python': 'py',
            'javascript': 'js',
