...
class Page(QWidget):
    ...
    def init_controls(self):
        """
        Initialize the controls area with model selection, temperature, and max tokens settings.
        """
        ...
        temp_label.setObjectName("temperatureLabel")
        ...
        temp_group.addWidget(temp_label)
        temp_group.addLayout(temp_controls)
        layout.addLayout(temp_group)
        logger.debug("Temperature controls initialized.")

        # Max Tokens Controls Group
        tokens_group = QVBoxLayout()
        tokens_label = QLabel("Max Tokens:")
        tokens_label.setObjectName("maxTokensLabel")
        ...
        prompt_group.addWidget(prompt_label)
        prompt_group.addWidget(self.system_prompt_combobox)
        layout.addLayout(prompt_group)
        logger.debug("System prompt controls initialized.")

        # Add stretch to keep controls left-aligned
        layout.addStretch()
        logger.debug("Controls widget initialization complete.")
